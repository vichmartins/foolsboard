...
// Corner brackets = fit the board to the screen.
...
// Stacked rows = a category (section grouping folders/boards).
...
// Stacked lines + a plus = create a new category (section).
...
// Magnifier = searching / browsing the gallery.
...
// --- Rich-text editor toolbar icons (stroke, 24x24, currentColor) ----------
...
// --- Object-kind icons (colored to match each kind's tag) -----------------
// Clapperboard = Scene.
...
export function NoteIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v10l-6 6H5a1 1 0 0 1-1-1z" />
      <path d="M20 14h-5a1 1 0 0 0-1 1v5" />
    </svg>
  )
}
// Rounded square = a generic (untyped) Object.
...
// A page with text lines = a rich-text document node.
...
// Four-way arrows = moving an item.
...
// Crescent moon = away from keyboard (idle).
...
// Panel-with-rail = toggle the left explorer sidebar.
...
// Right chevron (rotated via CSS when a folder is expanded).
...
// Text alignment icons (rows of lines).
...
// A side panel (used for the screenplay Scene Navigator toggle).
